...
func NewClient() (aliClient *alipay.Client, err error) {
...
func TestAlipayTradePreCreate(t *testing.T) {
	req := alipay.TradePreCreateRequestParams{
		OtherRequestParams: alipay.OtherRequestParams{
			NeedEncrypt:  true,
			ReturnUrl:    "",
			NotifyUrl:    "http://scwnex.natappfree.cc/notify",
			AppAuthToken: "",
		},
	...
	res, err := aliClient.TradePreCreate(req)
	if err != nil {
		t.Log(err)
		return
	}
...
func TestTradeAppPay(t *testing.T) {
	...
	res, err := aliClient.TradeAppPay(req)
	if err != nil {
		t.Log(err)
		return
	}
...
func TestTradePagePay(t *testing.T) {
	...
	html, urlRe, err := aliClient.TradePagePay(req)
	if err != nil {
		t.Log(err)
		return
	}
...
func TestFundTransUniTransfer(t *testing.T) {
	...
	res, err := aliClient.FundTransUniTransfer(req)
	if err != nil {
		t.Log(err.Error())
		return
	}
